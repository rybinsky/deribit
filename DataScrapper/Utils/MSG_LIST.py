...
def make_trades_subscription_request_by_currency(currency: Currency,
                                                 kind="option",
                                                 interval="100ms"):
...
def get_user_portfolio_request(currency: Currency) -> dict:
    _msg = \
        {"jsonrpc": "2.0",
         "method": "private/subscribe",
         "id": 42,
...
def get_positions_request(currency: Currency, kind="future"):
    msg = \
        {
            "jsonrpc": "2.0",
            "id": 2236,
