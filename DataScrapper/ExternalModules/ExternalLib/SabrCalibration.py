...
from DataScrapper.Utils.AvailableInstrumentType import InstrumentType
try:
    from DataScrapper.ExternalModules.AbstractExternal import AbstractExternal
    from DataScrapper.InstrumentManager import AbstractInstrument
except ImportError:
    from ..AbstractExternal import AbstractExternal
    from DataScrapper.InstrumentManager.AbstractInstrument import AbstractInstrument
